  ...
  return (
    <>
      ...
      <div className="absolute bottom-4 left-4 right-4 z-10 flex items-end justify-between pointer-events-none">
        ...
        {/* 右侧：统计信息 */}
        <div 
          className="pointer-events-auto bg-background/80 backdrop-blur-sm px-3 py-2 rounded-md border shadow-sm text-xs text-muted-foreground font-medium flex gap-3"
          onMouseDown={(e) => e.stopPropagation()}
        >
